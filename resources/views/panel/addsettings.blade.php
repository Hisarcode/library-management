    ...
    <div class="module">
        ...
        <div class="row">
            <div class="module-body column">
                <h2 style="text-align:center; font-family:'Times New Roman', Times, serif">Kelas</h2>
                <form class="form-horizontal row-fluid">

                    <div class="control-group">
                        <label class="control-label">Nama Kelas</label>
                        <div class="controls">
                            <input type="text" id="branch" data-form-field="branch" placeholder="Masukkan Nama Kelas"
                                class="span12">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button type="button" class="btn btn-inverse" id="addBranch">Tambah</button>
                        </div>
                    </div>
                </form>
                <br>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn btn-group">
                                    <a href="{{route('class.edit', $branch->id)}}"><i class="icon-edit"></i></a>
            ...
            <div class="module-body column">
                <h2 style="text-align:center; font-family:'Times New Roman', Times, serif">Kategori Kelas</h2>
                <form class="form-horizontal row-fluid">
                    <div class="control-group">
                        <label class="control-label">Kategori Kelas</label>
                        <div class="controls">
                            <input type="text" id="student_category" data-form-field="student_category"
                                placeholder="Masukkan Kategori Kelas Disini" class="span12">
                            <input type="hidden" data-form-field="token" value="{{ csrf_token() }}">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" id="max_allow" data-form-field="max_allowed"
                                placeholder="Masukkan Jumlah Maksimal Disini" class="span12">
                        </div>
                    </div>

                    <div class="control-group">
                        <div class="controls">
                            <button type="button" class="btn btn-inverse" id="addStudentCategory">Tambah</button>
                        </div>
                    </div>
                </form>
                <br>
                <table class="table table-striped" style="margin-left: 30px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn btn-group">
                                    <a href="{{route('student.category.edit', $student_category->cat_id)}}"><i
                                            class="icon-edit"></i></a>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header ">
                                        ...
                                        <h5 class="modal-title" id="exampleModalLabel">Hapus Kategori Kelas</h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('student.destroy', $student_category->cat_id) }}"
                                            ...
                                            @csrf
                                            @method('Delete')
                                            <p>Apakah anda yakin ingin menghapus ({{ $student_category->category }})
                                                kategori kelas ? </p>
